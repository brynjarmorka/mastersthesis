...
% \begin{enumerate}
%     \item Expanding the performance test with linearity, stability, shadowing, optimal WD, and detector efficiency
%     \item Using PCA for noise reduction in EDS maps
%     \item Completing the XPP correction model, where input specimen have unknown composition
% \end{enumerate}
...
% DONE detector efficiency (see BAM, it is hard to measure good)
