...
Reference values for characteristics like the Fiori P/B \cite{fiori_peak_background_1982} are available in the literature, but these values are are specified for older Si(Li) type of EDS detectors and may not apply to the SDDs \cite{sdd_lechner_2001}.
...
The avaliable quantification method in the published version of HyperSpy utilize the thin-film approximation, which is for thin TEM specimen.
