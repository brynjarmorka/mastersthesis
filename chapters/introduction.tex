...
% \brynjar{DONE REWRITE: (i) Experimental setup characteristics includes energy resolution in the acquired spectrum, signal-to-noise ratio (SNR) like the Fiori peak-to-background , detector efficiency, take off angle (TOA), shadowing, and system related artifacts such as strays\cite{goldstein_scanning_2018}.
% (ii)
% (ii) Similarly, 
...
The overall aim, as stated by the project title, is to improve SEM EDS data analysis in open-source software.
