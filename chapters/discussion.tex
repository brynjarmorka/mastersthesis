...
% TODO ton: "I would use this in dicussion, here only report general observations. There could be different reasons (correction needed, wrong k-factor or too low overvoltage (refer to theory part). In discussion you can name all three and then say what is most likely/main contribution For discussion: The need for improvement and tailoring for low HT becomes apparent."


% TODO ton, on the summary table: "How did you wanted to discus and draw conclusions from these numbers? Errors and ranges, as absorption and constants, are case dependent."


% TODO: rewirte, taken from results:
...
% TODO kanskje: illustration of different r/x, maybe with the phi(rho z) in discussion?
...
% TODO discuss: Other methods, such as the PROZA96 model, could be tested in future works, using the code developed in this work as a starting point, because there are overlapping parts between the models.

% TODO discussion: add PAP $\phi(\rho z)$ curves.
...
\begin{figure}[htbp]
    ...
    \caption{
        ...
        \brynjar{TODO: As of now, the numbers on the y-axis are correct, but the x-axis is off by a factor of 10, I think.}
    }
