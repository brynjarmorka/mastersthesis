...
Yet another possibility is to test other correction methods, such as the PROZA96 model \cite{bastin_proza96_1998}.
...
% DONE discuss: selge at jeg har skrevet teori og implementeri i kode, selge det.
% The XPP implemented is far from finished, but it is a starting point for future work.
% DONE discuss. but it is far from a finished results. Probably both a problem with the interpretation and the implementation of the XPP bulk corrections in the notebook. This can be investigated further, and the advice is to start with ...
% DONE discuss: føles ikke perfekt, men er et steg i riktig retning. Sub tings kan jeg plotte, men det er mange likninger som kan være litt feil. Små feil i koden eller i parameters som rho eller mu kan gi store utslag.
...
\brynjar{TODO: Do I need this here? I do not think so. If no, also remove from results (unfinished).}
