...
% The output spectra had few artifact related issues. % Ton: "I would take this out. Artifacts could be mentioned, but you recognizing these manually, not via notebook."
...
% linearity and stability, as well as the efficiency across the spectrum range, which all require an extended notebook and acquisition routine.
...
The implemented XPP model looks more promising than the ZAF model, but this first implementation needs to be further refined, for example through input factors like the mass absorption coefficient. % $\mu_\rho$.
