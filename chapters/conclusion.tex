...
% Quantification
% the 50:50 goal 
Assessing the quality of different quantification results based on a reference goal at $50:50$, which is known to be correct with the analysed specimen, is not an ideal solution.
