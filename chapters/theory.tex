...
% figures/SE_images/SE_vs_BSE.jpg
\begin{figure}[p]
    \centering
...
% spectrum from the digital signals.
...
The relation between peak width and peak energy is described in \cref{theory:eds_performance:energyres}. %, e.g. with \cref{eq:estimateFWHM}.
...
% DONE: mention advices U in discussion
...
% DONE discuss: software removing escape peaks.
...
% DONE suggested standard specimen:
...
% NOT DONE: amplifier noise is described with an equation in Woldseth 1973, referenced in bennett_egerton_1995.
...
% DONE discuss: yes, the advice of higher throughput for a bit lower e-res is nice and confirmed.
...
% DONE: In discussion debate this choice to alternatives.
...
% TODO discuss: the Fiori P/B increase with E_0 in SEM too, as stated in W&C. I do not know why, but mention it
...
% DONE: results and discussion on this
...
% DONE discuss: mu_rho real is also affected by other elements present, e.g. C and O. Thus mislabeling is even a feilkilde here, and the mu_rho used can be off because of this.
...
% NOT DONE theory: illustrate the TOA and (rho z)?
...
% DONE discuss: why the correction shuld be divided by Q(U), as it can be viewed as a probability.
% DONE discuss: not including 1/Q gave very wrong results, and were excluded from the results, but can be tested with the Notebook.
% DONE discuss: both multiplying with Q and ignoring Q gave unstable and unreasonalbe results.
% DONE: do not mention notebook in theory.
...
% add back the sentence below? No
