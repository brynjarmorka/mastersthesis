...
\brynjar{From Ton: "if not used, do not include them. But consider to use them in discussion leading to concrete future work (last chapter)"}
...
The matrix correction methods tested in this work are (1) the absorption correction through the ZAF-method, and (2) the PAP algorithm \cite{pap_1991}.
