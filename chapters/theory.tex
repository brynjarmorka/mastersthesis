...
\brynjar{From Ton: "could give the formula for the k-factor, Williams and Carter give it for example, and then discus that it has a set-up part (detector size, efficiency) and a physics side (cross-section for processes)"}.
