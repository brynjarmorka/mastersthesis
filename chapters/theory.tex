...
\ton{Should I include a figure with natural line widths and actual line widths in a spectrum?}
...
% figures/background_generated_detected.png
\begin{figure}[pht]
    \centering
...
% figures/background_absorptionEdge_Si.png
\begin{figure}[pht]
    \centering
...
\begin{figure}[ht]
    ...
    \caption{
        ...
        The figure is borrowed from Goldstein \cite[Fig. 3.1 a]{goldstein_scanning_2018}, which use data from \cite{koshikawa_SE_spectrum_1973}.
    }
...
More on the energy resolution is discussed in \cref{theory:eds_performance:energyres}.
...
The ionization cross-section is the probability of an ionization, described in detail in \verb|\cref{...}|.
...
As seen in the figure, the probability of ionization increase sharply until U is around 5, and then it decrease logarithmic and flattens.
Having an overvoltage below 1 results in no X-rays generated for the line of interest.
...
If the overvoltage for a line is 1, the electrons which loose energy near the surface will not have enough energy to ionize the line of interest.
This results in fewer generations of X-rays from that line, i.e. low intensity of the line.
As the overvoltage increase from 1, both the ionization cross-section and the amount of electrons with enough energy to scatter first and still ionize the line of interest increase.
...
A higher overvoltage will produce more X-rays, but also decrease the spatial resolution of the analysis as the interaction volume is increased with higher E$_0$.
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.95\linewidth]{figures/eds_artifacts.png}
    \caption{
