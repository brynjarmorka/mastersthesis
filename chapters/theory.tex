...
\ton{Should I include a figure with natural line widths and actual line widths?}
...
\ton{More on modelling here? I think no, and maybe add more in the data section.}


% the energy, 1/E
The energy lost by an electron in a single scattering event can be any value from zero to the incident electron energy, E$_0$.
