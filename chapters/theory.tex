...
The FWHM measurement should be from a Gaussian fit of the peak, because it cancels out the influence of the count statistics, as explained in \verb|\cref{gaussian_something}| \brynjar{fix internal reference}.
...
Even though the definition of the Fiori P/B is simple, the actual calculation of the metric is confusingly reported as slightly different in different sources.
...
The topic of choosing a standard material is covered in \brynjar{TODO: ref to standard material section, if included.}
